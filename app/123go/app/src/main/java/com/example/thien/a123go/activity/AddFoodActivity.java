...
public class AddFoodActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        inputName = (EditText) findViewById(R.id.foodName);
        inputPrice = (EditText) findViewById(R.id.foodPrice);
        inputDiscount = (EditText) findViewById(R.id.foodDiscount);
        inputDescription = (EditText) findViewById(R.id.foodDescription);
        ...
        btnAddFood.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ...
                String discount = inputDiscount.getText().toString().trim();
                String description = inputDescription.getText().toString().trim();

                if (!name.isEmpty() && !price.isEmpty() && !discount.isEmpty() && !description.isEmpty()) {
                    addNewFood(name, price, discount, description);
                } else {
    ...
    private void addNewFood(final String name, final String price,
                            final String discount, final String description) {
        // Tag used to cancel the request
        String tag_string_req = "req_add_food";

        pDialog.setMessage(getResources().getString(R.string.uploading));
        showDialog();

        StringRequest strReq = new StringRequest(Request.Method.POST,
                AppConfig.URL_ADD_FOOD, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (error.compareTo("ok") == 0) {
                        startActivity(new Intent(getBaseContext(), ManageMenuActivity.class));
                    } else {
            ...
            protected Map<String, String> getParams() {
                ...
                params.put("counter_id", session.getString(SessionManager.KEY_COUNTER_ID));
